...
Tags: sliding panels, modal window, pop up window, jQuery, JavaScript, web 2.0
Requires at least: 3.0
Tested up to: 3.2
Stable tag: 1.1.3

TheThe Sliding Panels plugin provides 5 types of Javascript-powered panels floating above the main webpage.

== Description ==

[TheThe Sliding Panels](http://thethefly.com/wp-plugins/thethe-sliding-panels/ "TheThe Sliding Panels") Wordpress plugin provides 5 types of JavaScript-powered Sliding Panels - *Top*, *Bottom*, *Left*, and *Right* side panels and a *Modal Window* floating above the main webpage. 
...
These sliding panels can be used to organize your content in a Web 2.0 style. The panels work well for:
...
3. Activate the 'TheThe Sliding Panels' plugin via the 'Plugins' page of your WordPress Admin Dashboard.
4. Open the plugin configuration page, which is located under TheThe Fly -> Sliding Panels and manage your panels.
...
= Once TheThe Sliding Panels WordPress plugin has been configured and activated, how can I place my content into it? =
...
= How can I add some logic to my sliding panels appearance? =

That's quite simple, actually. We recommend you to get FREE WP Plugins like *Widget Context* or *Widget Logic* to add logic to the widgets you are placing into the widget areas of the sliding panels.

= What is that 'Suppressing Cookie' panel parameter for? =
...
= I have entered all parameters - *Corner Radius*, *Shadow Size* and *Color* for my sliding panel but it seems that they are all ignored. How can I change the parameters for my sliding panels? =
...
1. The screenshot of a Modal Window
2. The screenshot of a Modal Window 2
3. The screenshot of Top/Right/Bottom sliding Panels
4. The plugin's Admin Panel screenshot
5. The look of your Widgets admin page once sliding panels activated
...
= 1.1.2 =
* Image in modal window in IE bug fixed.

= 1.1.1 =
* Trigger tabs in IE9 bug fixed.

= 1.1.0 =

* New pannels/modal window cookie-controled appearance logic added.
...
* Conflict with the theme's sidebars declared without IDs fixed.

= 1.0.1 =

* About the Club page added
