...
#<?php echo $option; ?> {
 ...
 #<?php echo $option; ?>container a.cs-active { background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/nav_style5.png') no-repeat;background-position: bottom; outline: none !important;}
        ...
        default: { ?>
           #<?php echo $option; ?>container .cs-buttons { font-size: 0px; padding: 0px; float: left; outline: none !important;}
           #<?php echo $option; ?>container .cs-buttons a { margin-left: 5px; height: 15px; width: 15px; float: left;
...
class vslider_widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		echo $before_widget;
			...
			echo '<div class="latest_work"><div class="latest_work_box" style=" padding-bottom: 20px;">';
			echo '<h1>';
			if (!empty($instance['title'])) {
				echo $instance['title'];
			 }
			echo '<span> work</span>';
			echo '<img src="'.get_bloginfo( template_directory ).'/images/plus.png" alt=""><a href="#">more</a></h1>';
