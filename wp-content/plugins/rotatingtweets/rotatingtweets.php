    ...
    function widget($args, $instance) {
        ...
        ?>
              <?php echo $before_widget;
						...
						echo '<br/><p class="recent">&nbsp;&nbsp;Follow Us<br><a href="http://twitter.com/'.$newargs['screen_name'].'" target="_blank">@'.$newargs['screen_name'].'</a></p>';
			...
			if($tweet_counter <= $tweet_count):
				...
				if(!empty($main_text)):
					...
					if($args['show_meta_timestamp']):
						$meta .= "<a target= '_blank' href='http://twitter.com/".$user->screen_name."/status/".$twitter_object->id_str."'>".ucfirst(rotatingtweets_contextualtime(strtotime($twitter_object->created_at)))."</a>";
					endif;
